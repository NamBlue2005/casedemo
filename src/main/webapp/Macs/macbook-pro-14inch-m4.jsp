...
<head>
    ...
    <title>MacBook Pro 14 inch M4</title>
...
<section class="product-detail">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img src="Img/MacBook-Pro-14inch-M4.jpeg" class="product-image" alt="MacBook Pro 14 inch M4">
            </div>

            <div class="col-md-6">
                <h1 class="product-title">MacBook Pro 14 inch M4</h1>
                <p class="product-price">$1499</p>
                <p class="product-description">
                    MacBook Pro 14 inch M4 với chip Apple M4 mạnh mẽ, màn hình Liquid Retina XDR sắc nét, và các tính năng mạnh mẽ cho công việc sáng tạo và xử lý hiệu suất cao. Sản phẩm này đặc biệt thích hợp cho các nhà sáng tạo nội dung và chuyên gia thiết kế.
                </p>
                ...
                <div class="product-specs">
                    ...
                    <ul>
                        ...
                        <li><strong>Màn hình:</strong> 14 inch Liquid Retina XDR, hỗ trợ độ phân giải cao và HDR, mang đến chất lượng hình ảnh xuất sắc</li>
                        <li><strong>RAM:</strong> 16GB hoặc 32GB LPDDR4X (tùy chọn)</li>
                        <li><strong>Bộ nhớ:</strong> 512GB, 1TB, 2TB, hoặc 4TB SSD (tùy chọn)</li>
                        <li><strong>Card đồ họa:</strong> GPU 16 nhân (trên bản cơ bản) hoặc 32 nhân (trên bản cao cấp)</li>
                        <li><strong>Pin:</strong> Thời gian sử dụng lên đến 17 giờ với pin 70Wh, hỗ trợ sạc nhanh</li>
                        <li><strong>Cổng kết nối:</strong> 3 cổng Thunderbolt 4 (USB-C), 1 cổng HDMI, 1 đầu đọc thẻ SDXC, Jack tai nghe 3.5mm</li>
                        <li><strong>Hệ điều hành:</strong> macOS Monterey, hỗ trợ các tính năng mới nhất và tối ưu cho chip M4</li>
                        <li><strong>Webcam:</strong> Camera FaceTime HD 1080p</li>
                        ...
                        <li><strong>Kích thước:</strong> 31.26 x 22.12 x 1.55 cm, trọng lượng 1.61 kg</li>
