...
<%
  ...
  cartService.addProductToCart(new Product(1, "Iphone 16", 999, "Mô tả sản phẩm Iphone 16"), 1);
  cartService.addProductToCart(new Product(2, "Macbook Air", 1200, "Mô tả sản phẩm Macbook Air"), 1);

  String productIdToRemove = request.getParameter("remove");
  if (productIdToRemove != null) {
    cartService.removeProductFromCart(Integer.parseInt(productIdToRemove));
  }

  String productIdToUpdate = request.getParameter("update");
  String newQuantity = request.getParameter("quantity");
  if (productIdToUpdate != null && newQuantity != null) {
    cartService.updateProductQuantity(Integer.parseInt(productIdToUpdate), Integer.parseInt(newQuantity));
  }
%>
